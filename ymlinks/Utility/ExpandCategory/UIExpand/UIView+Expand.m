...
- (void)ex_addTransparentLayerInFrame:(CGRect)frame AndRadius:(CGFloat)radius {
    ...
    UIBezierPath *path = [UIBezierPath bezierPathWithRect:CGRectMake(0, 0, mainScreen_Width, mainScreen_Height)];
...
- (void)ex_addDefaultShadow{
    ...
    self.layer.shadowColor   = [RGBCOLOR(198, 198, 198) CGColor];
